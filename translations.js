// Shared trilingual dictionary (EN/FR/AR). Loaded by both the site and the admin CMS.
// This is the single source of truth for default page text; admin overrides merge on top.
window.translations = {
  en: {
    nav_home: "Home",
    nav_about: "About Us",
    ...
    hero_quote_1: "Numbers tell a story. We help you read it clearly.",
    hero_quote_2: "Precision today builds the confidence you rely on tomorrow.",
    hero_quote_3: "Big-firm rigor, delivered with the care of a trusted partner.",
    hero_tagline: "Clarity you can build on.",
    careers_sent_thanks: "Thank you, your application has been received. We will be in touch.",
    ...
    careers_desc_junior: "Entry-level role for recent graduates beginning a career in audit and assurance, working closely with senior staff.",
    careers_desc_accountant: "Role focused on bookkeeping, financial reporting, and month-end close for a portfolio of clients.",
  ...
  fr: {
    ...
    hero_quote_1: "Les chiffres racontent une histoire. Nous vous aidons à la lire clairement.",
    hero_quote_2: "La précision d'aujourd'hui bâtit la confiance de demain.",
    hero_quote_3: "La rigueur d'un grand cabinet, avec l'attention d'un partenaire de confiance.",
    hero_tagline: "Une clarté sur laquelle bâtir.",
    careers_sent_thanks: "Merci, votre candidature a bien été reçue. Nous vous recontacterons.",
    ...
    careers_desc_junior: "Poste de premier échelon pour les jeunes diplômés débutant une carrière en audit et assurance, aux côtés de l'équipe senior.",
    careers_desc_accountant: "Poste axé sur la tenue de comptes, le reporting financier et la clôture mensuelle pour un portefeuille de clients.",
  ...
  ar: {
    ...
    hero_quote_1: "الأرقام تروي قصة، ونحن نساعدك على قراءتها بوضوح.",
    hero_quote_2: "الدقة اليوم تبني الثقة التي تعتمد عليها غداً.",
    hero_quote_3: "دقة الشركات الكبرى، مع عناية شريك موثوق.",
    hero_tagline: "وضوحٌ تبني عليه.",
    careers_sent_thanks: "شكراً لك، تم استلام طلبك. سنتواصل معك قريباً.",
    ...
    careers_desc_junior: "دور مبتدئ للخريجين الجدد الذين يبدؤون مسيرتهم في التدقيق والضمان، بالعمل عن قرب مع الطاقم الأول.",
    careers_desc_accountant: "دور يركز على مسك الدفاتر وإعداد التقارير المالية والإقفال الشهري لمحفظة من العملاء.",
