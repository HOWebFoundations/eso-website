...
window.translations = {
  en: {
    ...
    hero_quote_1: "Every figure checked. Every risk understood.",
    hero_quote_2: "Clarity you can build on.",
    hero_quote_3: "Straight answers from advisors who know Lebanon.",
  ...
  fr: {
    ...
    hero_quote_1: "Chaque chiffre vérifié. Chaque risque compris.",
    hero_quote_2: "Une clarté sur laquelle bâtir.",
    hero_quote_3: "Des réponses franches, par des conseillers qui connaissent le Liban.",
  ...
  ar: {
    ...
    hero_quote_1: "كل رقم مُدقَّق، وكل مخاطرة مفهومة.",
    hero_quote_2: "وضوحٌ تبني عليه.",
    hero_quote_3: "إجابات صريحة من مستشارين يعرفون لبنان.",
