...
const translations = {
  en: {
    ...
    guide_browse_decrees: "Browse the MoF decrees archive",
  ...
  fr: {
    ...
    guide_browse_decrees: "Consulter l'archive des décrets du ministère des Finances",
  ...
  ar: {
    ...
    guide_browse_decrees: "تصفّح أرشيف مراسيم وزارة المالية",
